...
?>
<article id="post-<?php the_ID(); ?>" <?php post_class('post-list__item'); ?> <?php if (has_post_thumbnail()) { echo 'style="background-image:linear-gradient(rgba(0,0,0,0.75), rgba(0,0,0,0.50)),url(\''; the_post_thumbnail_url(); echo '\')"';} ?>>
