...
let compressCss = function () {
  return new Promise(function (resolve, reject) {
    return new compressor.minify({
      type: 'clean-css',
      fileIn: cssFileName,
      fileOut: buildFolderName + '/' + cssFileName,
...
let copyHtml = function () {
  return copyFile(appFolder + 'index.php', buildFolderName + '/index.php')
    .then(function (res) {
      log(chalk.green('[' + dateFormat(new Date(), 'HH:MM:ss') + '] ') + 'index.php copied')
    })
    .catch(console.err)
}
